...
func funcCompact() (a, b int) { // want "declare the type of function return values explicitly"
	return 0, 0
}
...
func funcLitCompact() {
	_ = func() (a, b int) { // want "declare the type of function return values explicitly"
		return 0, 0
	}
}
...
func (f foo) methodExplicit() (a int, b int) {
	return 0, 0
}
...
func (f foo) methodCompact() (a, b int) { // want "declare the type of method return values explicitly"
	return 0, 0
}
